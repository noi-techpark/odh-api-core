...
namespace SIAG
{
    public class GetWeatherFromSIAG
    {
        public const string serviceurlsiag =
            @"https://wetter.ws.siag.it/Weather_V1.svc/web/getLastProvBulletin";
        public const string serviceurlbezirksiag =
            @"https://wetter.ws.siag.it/Agriculture_V1.svc/web/getLastBulletin";
        ...
        )
        {
            try
            {
                ...
                wrCache.Add(
                    new Uri(requesturl),
                    "Basic",
                    new NetworkCredential(siaguser, siagpswd)
                );
        ...
        )
        {
            ...
            {
                string requesturl =
                    serviceurlbezirk + distid + "/bulletin?lang=" + lang + "&format=xml";
