...
namespace OdhApiImporter.Helpers.LTSAPI
{
    public class LTSApiGastronomyCategoriesImportHelper : ImportHelper, IImportHelper
    {
        ...
        private async Task<List<JObject>> GetGastronomyCategoriesFromLTSV2()
        {
            ...
            {
                WriteLog.LogToConsole("", "dataimport", "list.gastronomies.categories", new ImportLog() { sourceid = "", sourceinterface = "lts.gastronomies.categories", success = false, error = ex.Message });
