...
namespace LCS
{
    public class GetGastronomicDataLCS
    {
        ...
        public ServiceReferenceLCS.GastronomicDataChangedItemsRS GetGastronomicDataChanged(
            XElement myrequest
        )
        {
        ...
        public ServiceReferenceLCS.GastronomicDataSearchRS GetGastronomyListLTS(
            int pagesize,
            string language,
            string ltsmsgpswd
        )
