...
namespace OdhApiCore.Controllers.api
{
    ...
    public class ODHActivityPoiController : OdhController
    {
        ...
        /// <param name="polygon">Bounding Box Filter bbc: 'Bounding Box Contains', 'bbi': 'Bounding Box Intersects', followed by a List of Comma Separated Longitude Latitude Tuples / OR a valid WKT (Well-known text representation of geometry) Format, Examples (POLYGON ((30 10, 40 40, 20 40, 10 20, 30 10))), 'null' = disabled, (default:'null') <a href='https://github.com/noi-techpark/odh-docs/wiki/Geosorting-and-Locationfilter-usage/_edit#polygon-filter-functionality' target="_blank">Wiki geosort</a></param>
            ...
            return DoAsyncReturn(async () =>
            {
                ...
                var query =
                    QueryFactory.Query()
                        ...
                        .When(polygonsearchresult != null, x => x.WhereRaw(PostgresSQLHelper.GetGeoWhereInPolygon_GeneratedColumns(polygonsearchresult.wktstring, polygonsearchresult.polygon, polygonsearchresult.operation)))
