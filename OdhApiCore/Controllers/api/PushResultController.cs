...
namespace OdhApiCore.Controllers
{
    ...
    {
        public PushResponseController(IWebHostEnvironment env, ISettings settings, ILogger<PushResponseController> logger, QueryFactory queryFactory, IOdhPushNotifier odhpushnotifier)
        ...
        public async Task<IActionResult> GetPushResultSingle(string id,
            [ModelBinder(typeof(CommaSeparatedArrayBinder))]
            string[]? fields = null,            
            bool removenullvalues = false,
            CancellationToken cancellationToken = default)
