...
namespace OdhApiCore.Controllers.api
{
    ...
    public class PoiController : OdhController
    {
            ...
            return DoAsyncReturn(async () =>
            {
                ...
                var query = QueryFactory
                    ...
                    .PoiWhereExpression(
                        ...
                        poitypelist: myactivityhelper.poitypelist,
        ...
        private Task<IActionResult> GetPoiTypesSingleAsync(
            string id,
            string? language,
            string[] fields,
            bool removenullvalues,
        ...
        public Task<IActionResult> Post([FromBody] LTSPoiLinked poi)
        {
            return DoAsyncReturn(async () =>
            {
                ...
                return await UpsertData<LTSPoiLinked>(
                    poi,
                    new DataInfo("pois", CRUDOperation.Create),
        ...
        public Task<IActionResult> Delete(string id)
        {
            return DoAsyncReturn(async () =>
            {
                ...
                return await DeleteData<LTSPoiLinked>(
                    id,
                    new DataInfo("pois", CRUDOperation.Delete),
                    new CRUDConstraints(additionalfilter, UserRolesToFilter)
                );
            });
        }
