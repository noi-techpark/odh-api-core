...
namespace OdhNotifier
{
    ...
    {         
        ...
        private static bool HasAccoChanged(Accommodation myacco, Accommodation oldacco, List<AccoRoom> newrooms, List<AccoRoom> oldrooms)
        {
            ...
            accoequal = EqualityHelper.CompareClasses<Accommodation>(myacco, oldacco, new List<string>() { "LastChange" });
                        ...
                        else
                        {
                            if (hgvoldrooms.Count() == hgvnewrooms.Count())
                            {
                                ...
                                foreach (var hgvnewroom in hgvnewrooms)
                                {
                                    ...
                                    if (hgvoldroom != null)
                                    {
                                        var hgvroomresult = EqualityHelper.CompareClasses<AccoRoom>(hgvnewroom, hgvoldroom, new List<string>() { "Id", "LastChange" });
