...
namespace MSS
{
    public class ParseMssResponse
    {
        ...
        )
        {
            ...
            {
                foreach (
                    XElement mytime in mssresponse
                        .Root.Elements("root")
                        .Elements("header")
                        .Elements("time")
                )
        ...
        )
        {
            try
            {
                ...
                )
                {
                    ...
                    if (
                        myhotelresult.Elements("channel").Count() > 0
                        && !String.IsNullOrEmpty(myhotelresult.Element("id_lts").Value)
                    )
                    {
