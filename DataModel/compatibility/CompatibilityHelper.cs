...
namespace DataModel
{
    ...
    public static class CompatibilityHelper
    {
        ...
        public static string GetOldEventShortTagnames(string taglowercase) =>
            taglowercase switch
            {
        ...
        public static string ConvertArticleTypesToTags(string type) =>
            type switch
            {
        ...
        public static string ConvertArticleSubTypesToTags(string subtype) =>
            subtype switch
            {
