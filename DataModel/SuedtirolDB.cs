...
namespace DataModel
{
                    ...
                    {
                        {
                            ...
                            new GpsInfo()
                            {
                                ...
                                AltitudeUnitofMeasure = this.AltitudeUnitofMeasure,
    ...
    //BaseInfo Article
    public abstract class ArticleBaseInfos
        : IIdentifiable,
            IActivateable,
            IImageGalleryAware,
            IContactInfosAware,
    ...
    //BaseInfo Gastronomy
    public abstract class GastronomyBaseInfos
        : IIdentifiable,
            IActivateable,
            IGpsInfo,
            IImageGalleryAware,
    ...
    //BaseInfo Events
    public abstract class EventBaseInfos
        : IIdentifiable,
            IActivateable,
            IImageGalleryAware,
            IGpsInfo,
