...
//        private static Schema.NET.Hotel TransformAccommodationToLD(SuedtirolDB.Accommodation acco, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
...
//        private static Schema.NET.Restaurant TransformGastronomyToLD(SmgPoi gastro, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
...
//        private static List<Schema.NET.Event> TransformEventToLD(SuedtirolDB.Event theevent, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//        private static Schema.NET.TouristAttraction TransformActivityPoiToLD(SuedtirolDB.SmgPoi poi, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//		private static Schema.NET.Recipe TransformRecipeToLD(SuedtirolDB.RecipeArticle recipe, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//            myrecipe.DatePublished = new DateTimeOffset(recipe.LastChange);
//            myrecipe.DateModified = new DateTimeOffset(recipe.LastChange);
//            myrecipe.DateCreated = new DateTimeOffset(recipe.FirstImport);
...
//        private static RecipeDetails GetRecipeDetails(SuedtirolDB.RecipeArticle recipe, string language)
//        {
...
//		private static Schema.NET.Place TransformPlaceToLD(SuedtirolDB.Region placetotrasform, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//        private static Schema.NET.Place TransformPlaceToLD(SuedtirolDB.Tourismverein placetotrasform, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//        private static Schema.NET.Place TransformPlaceToLD(SuedtirolDB.Municipality placetotrasform, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
...
//        private static Schema.NET.Place TransformPlaceToLD(SuedtirolDB.District placetotrasform, string language, string passedid, string passedurl, string passedimage, bool showid)
//        {
//			string fallbacklanguage = "en";
//            //Winery, Museum
